...
class Scheme(models.Model):
    ...
    description = models.TextField(help_text="Enter description of scheme (e.g. Designed to Reduce Bridge Strikes)")
    ...
    completion = models.DecimalField(max_digits=3, decimal_places=2, help_text="Enter a percentage, (e.g. 25")
